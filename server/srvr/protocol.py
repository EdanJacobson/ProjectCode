...
class Protocol(object):
    ...
    def send(socket, data):
        ...
        :param data:
        """
        byte_value = str(len(data.encode())).zfill(constants.BYTE_SIZE).encode()
    ...
    def send_bin(socket, data):
        ...
        :param data:
        """
        byte_value = str(len(data)).zfill(constants.BYTE_SIZE).encode()
    ...
    def recv(socket):
        ...
        :param socket:
        """
        code_size_len = constants.READ_SIZE
        total_data = b''

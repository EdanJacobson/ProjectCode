...
from outlook.emailconstants import LEN_LIMIT, AT, CONTACTS_FILEPATH, OUTLOOK_APP, MAPI
...
class Contacts(object):
    ...
    def get_email_addresses(self):
        """
        Method that retrieves email addresses from Outlook that are embedded in locally stored emails
        :return:
        """
        ...
        for message in inner_folder.Items:
            try:
                ...
                for recipient in recipients:
                    ...
                    if address not in self.email_addresses and len(address) < LEN_LIMIT and AT in address:
    ...
    def extract_contacts():
        """
        Method that extracts contacts from a file and stores them in email_addresses list
        :return:
        """
        try:
